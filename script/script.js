...
function createProductElements(productArray, productArrayLinks, productType) {
   ...
   for (let i = 0; i < productArray.length; i++) {
      ...
      productImg.src = `./images/product/${productType}/product${i + 1}_${i + 1}_11zon.webp`;
